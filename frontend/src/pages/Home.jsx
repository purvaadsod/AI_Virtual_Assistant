...
function Home() {
 ...
 const handleCommand = (data) => {
    console.log("Data received from Gemini:", data); // Check your console (F12) to see this!

    if (!data || !data.response) {
      const fallback = "Sorry, I couldn't understand the response. Please try again.";
      speak(fallback);
      return;
    }
    ...
    // 2. Wrap actions in a small timeout to ensure they aren't blocked
    setTimeout(() => {
      const intent = type.toLowerCase().trim();
      const query = encodeURIComponent(userInput || "");

      if (intent === "google-search") {
        window.open(`https://www.google.com/search?q=${query}`, "_blank");
      } 
      else if (intent === "calculator-open") {
        window.open(`https://www.google.com/search?q=calculator`, "_blank");
      } 
      else if (intent === "instagram-open") {
        window.open(`https://www.instagram.com/`, "_blank");
      } 
      else if (intent === "facebook-open") {
        window.open(`https://www.facebook.com/`, "_blank");
      } 
      else if (intent === "weather-show") {
        window.open(`https://www.google.com/search?q=weather`, "_blank");
      } 
      else if (intent === "youtube-search" || intent === "youtube-play") {
